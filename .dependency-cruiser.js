...
module.exports = {
  forbidden: [
    ...
    {
      name: "shared-to-layouts",
      from: { path: "^src/app/shared" },
      to: { path: "^src/app/layouts" },
    },
    {
      name: "shared-to-features",
      from: { path: "^src/app/shared" },
      to: { path: "^src/app/features" },
    },

    {
      name: "core-to-layouts",
      from: { path: "^src/app/core" },
      to: { path: "^src/app/layouts" },
    },
    {
      name: "core-to-features",
      from: { path: "^src/app/core" },
      to: { path: "^src/app/features" },
    },

    {
      name: "layouts-to-features",
      from: { path: "^src/app/layouts" },
      to: { path: "^src/app/features" },
    },
    {
    ...
    {
      name: "no-cross-layout-imports",
      from: {
        path: "^src/app/layouts/([^/]+)/",
      },
      to: {
        path: "^src/app/layouts/",
        pathNot: "^src/app/layouts/$1/",
      },
    },
  ],
  options: {
...
// generated: dependency-cruiser@18.1.0 on 2026-07-14T06:55:34.401Z
